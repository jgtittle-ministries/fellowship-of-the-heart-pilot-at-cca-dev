# Session 19, Evening Form — SECOND RUNNING: BLOCK B

**AUTO-ADAPTED DRAFT from `docs/getting-started/week-19-second-running-b.md`, which keeps
...
**Aim (from the school version).** Give every Companion-in-Formation two live small-room reps teaching the Signs Card and the Path Home Card — coached from inside the cluster, with one specific “keep” and one specific “adjust” after each rep — so that next Wednesday at The Long Walk they carry the same teaching to the whole room, steady, as their final rep before commissioning.
...
| 7:25-7:31 | Block 2: The frame — why these two cards | Content presenter; container holder watching the room |
| 7:31-7:32 | Block 3: Bridge and split | Content presenter; container holder watching the room |
| 7:32-7:52 | Block 4: First teaching rep — both cards | Content presenter; container holder watching the room |
| 7:52-7:57 | Block 5: pair feedback — one keep, one adjust | Content presenter; container holder watching the room |
| 7:57-7:59 | Rotation | Content presenter; container holder watching the room |
| 7:59-8:15 | Block 6: Second teaching rep — both cards, tightened | Content presenter; container holder watching the room |
| 8:15-8:19 | Block 7: Second pair feedback | Content presenter; container holder watching the room |
