# Session 8, Evening Form — HEARING GOD — PROAPT II

**AUTO-ADAPTED DRAFT from `docs/getting-started/week-08-proapt-2.md`, which keeps
...
**Aim (from the school version).** Complete the second running of PROAPT — the full six-step walk-through led by a Companion-in-Formation with a fresh passage.

**Anchor.** Romans 10:17 (faith comes from hearing) and Mark 2:1–12 (the paralytic through the roof) as the worked example.
...
| 7:43-8:11 | Block 6: PROAPT in family pairs in pairs | Content presenter; container holder watching the room |
| 8:11-8:17 | Block 7: Tell step — sharing in the pair | Content presenter; container holder watching the room |
| 8:17-8:20 | Block 8: Merge and between-session | Container holder leads the merge; content presenter supporting |
...
1. **The homework practice, week one.** Daily PROAPT continues (the journal Week 7–8 pages).
