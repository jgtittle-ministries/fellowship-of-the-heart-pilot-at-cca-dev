...
**IJH source.** Philippians 1:6 (the work in process); Hebrews 12:1–2 (the long-obedience anchor); Vol 5 Paul case study (the apostle’s pattern of return-and-strengthen, applied to each member returning to their Going Out journey to articulate what was formed); the Affective Taxonomy (Vol 4) as the implicit assessment frame for individual integration; Going Deeper Wk 11 (cohort-level assessment template that Wk 11 of the Going Out series scales).
