...
- [**Reading List**](reading-list.md) — an annotated guide for parents, teens, and the curious. Curated from the IJH Volume 5 bibliography for the Fellowship of the Heart audience.

---

## How they fit together

These four materials are designed to work together across the year:
...
A cohort can complete Getting Started using only the Personal Heart Journal and the Rhythm Card; the cards and reading list are invitations, not assignments. Going Deeper and Going Out lean more heavily on the shared materials as the cohort matures.
