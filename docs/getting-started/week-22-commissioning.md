...
## WEEK 22 — COMMISSIONING THE COMPANIONS (75 minutes)
...
**Connect focus.** All four. The seniors' own formation (Self), the community that witnesses (Others), the calling confirmed (God), the serving cycle entered (Mission).

**Mode.** Shared circle the entire session. The whole cohort and the families are present as witnesses — but this is the seniors' night. The seniors lead; the adults confirm and bless; the cohort witnesses.

**Center.** The four movements, in order. The rite is the session.

**Between-session practice.** For the new FC1s: the Leader Lab rhythm begins — bring one vital-signs observation from tonight's room to Lab 1 of the serving cycle. For everyone: the Rhythm Card and the Going Deeper interlude practices.
...
- The rite going long. Seventy-five minutes is enough if the team holds the blocks. The blessings are where nights like this run away; the form (specific, witnessed, brief) is the discipline, exactly as it was in Week 21.
...
**If anything heavier surfaces — a disclosure, a family conflict, anything from the Section 6 list.** Standard protocol. Two-adult rule. Step aside, do not interpret in the room, pastoral / clinical backup. The rite can pause and resume; a teen in crisis outranks the calendar.
...
In the CCA year this night lands at the school year's end, with summer ahead — which is exactly why the rite refuses to be a graduation. The new FC1s do not walk out of this room into a summer of forgetting: the first Leader Lab of the next serving cycle is on the calendar before anyone touches a coat, the covering each senior named tonight stands through the break, and the fall's next cohort — where their second-running slots are waiting — is already forming. The exit is an entrance. The calendar is the proof.
...
Email to all families: *"Wednesday is Week 22, our final gathering — Commissioning the Companions. This is the night our Companions-in-Formation, the seniors who led us this year, are commissioned as Formation Companions, Level One. The whole cohort and all families are wanted in the room: a commissioning needs witnesses, and they earned ours. 4:15 start, 5:30 close. Light dessert after."*
...
| 3:45 | Team stages in the hallway: crate, keepsakes, handouts ready. Final prayer for each senior by name. | All Companions |
| 4:00 | School releases the room. The build: circle, open center, handouts placed. | Team + teen room-build crew |
| 4:00–4:15 | Families welcomed as the room builds. | All Companions |
| 4:15 | Session opens. | Lead Comp — then the seniors |

# **Detailed 75-Minute Run Sheet**

*Times assume a 4:15 PM start; school releases the room at 4:00 and the room builds in the first fifteen minutes. The four movements are the architecture; the blocks serve them. Hold the times — a rite gains weight from form, and loses it from sprawl.*

| **Time** | **Block** | **Movement** | **Lead** | **Notes** |
| --- | --- | --- | --- | --- |
| 4:15–4:18 | Block 1: Welcome and framing | — | Lead Comp | Why tonight is a gate, not a graduation. The four movements named. Brief on purpose — the night belongs to the seniors. |
| 4:18–4:31 | Block 2: The final rep — the container opened | Movement 1 | The seniors | One senior opens from memory; the others each speak a condition from memory with a story. No scripts, no cards. |
| 4:31–4:38 | Block 3: The word over the night | — | Lead Comp | 2 Timothy 2:2 and 1 Timothy 4:12. The four generations. Prayer. |
| 4:38–4:46 | Block 4: The three rules read aloud | Movement 2 | Lead Comp + seniors | Verbatim from the handbook, to the whole room. The bright line made public. |
| 4:46–4:55 | Block 5: The covering named | Movement 3 | Each senior | Each new FC1 names their adult aloud. Parent + Lead Companion sign-off confirmed publicly. |
| 4:55–5:15 | Block 6: The commissioning | Movement 4 | Team, parents, cohort | Specific witnessed blessing over each FC1; the charge; the cohort speaks the Aaronic over them. |
| 5:15–5:19 | Block 7: The first Lab scheduled | Movement 4 | Lead Comp | The date announced aloud, held up, written down. The exit is an entrance. |
| 5:19–5:22 | Block 8: The Leader Feedback Round | — | The seniors + Lead Comp | The seniors who led the movements answer first, the adult second, then the room. May well be dropped tonight — see the block note. |
| 5:22–5:30 | Block 9: The final rep — the container closed | Movement 1 | A senior | A senior closes from memory. Sending. End. |
| 5:30+ | After: the signing, dessert, lingering | — | Everyone | The room signs each keepsake. Stay. |

# **Block-by-Block: Scripts and Notes**

## **Block 1 — Welcome and Framing (4:15–4:18, 3 min)**
...
*"Here is the shape of the night — four movements. First, the final rep: our seniors will open this container the way they have opened it all year — from memory, no script — because that is the spine of what an FC1 is. Second, we will read aloud the three rules that never bend, so that every one of you knows exactly the boundaries your young leaders keep. Third, each new FC1 will name their covering — the adult they call when they are over their head. And fourth, we commission them: we will speak blessing over them, all of us, and before anyone leaves this room, their first Leader Lab of the spring will be on the calendar. Watch for that last part. It is the proof that tonight is a beginning."*
...
## **Block 2 — The Final Rep: the Container Opened (4:18–4:31, 13 min) — MOVEMENT ONE**
...
## **Block 3 — The Word Over the Night (4:31–4:38, 7 min)**
...
## **Block 4 — The Three Rules Read Aloud (4:38–4:46, 8 min) — MOVEMENT TWO**
...
*The Lead Companion reads the first line of each rule; the seniors, together, may read them back — decide in the team meeting which way carries more weight for this group.*
...
## **Block 5 — The Covering Named (4:46–4:55, 9 min) — MOVEMENT THREE**
...
*"An FC1 never leads uncovered. Every one of these seniors has a standing covering — an adult with a name and a phone number, who has said yes, who they will call the moment something is over their head. Tonight they name that person out loud, because a covering that is public is a covering that holds."*

## Per senior (≈ 90 sec each)

**1. The senior stands and says it plainly:** *"When I am over my head, I call \_\_\_\_\_."* Name, and relationship — a parent, a pastor, an adult Companion, a mentor. If the covering person is in the room, they stand where they are.
...
## **Block 6 — The Commissioning (4:55–5:15, 20 min) — MOVEMENT FOUR, part one**
...
**4. The cohort speaks the Aaronic blessing over the new FC1** — the whole room, slowly, hands extended: *"The Lord bless you and keep you; the Lord make His face shine on you and be gracious to you; the Lord turn His face toward you and give you peace."*
...
## **Block 7 — The First Lab Scheduled (5:15–5:19, 4 min) — MOVEMENT FOUR, part two**
...
## **Block 8 — The Leader Feedback Round (5:19–5:22, 3 min)**
...
## **Block 9 — The Final Rep: the Container Closed (5:22–5:30, 8 min) — MOVEMENT ONE, completed**
...
*Lead Companion: resist the urge to add anything after the senior's sending. If the senior sends the room, the room is sent. The final word of the series belongs to a new FC1, and the team's silence after it is the loudest confirmation in the room.*

*One note for the closing senior, given privately beforehand: in the blessing round, expect the room to bless you and your fellow FC1s more than usual. Receive it. Then finish the protocol. Ending well under a full heart is the most FC1 thing you will do all night.*

## **After (5:30+): the signing, dessert, lingering**
...
- One sentence in the blessing block — the discipline protects them from the speech they may want to give and preserves the sentence the teen will keep.
- The confirming word in Block 5 ("I confirm it") is theirs. Some parents will need to hear beforehand that two words spoken plainly carry more than a paragraph.

## **The families not directly connected to a senior**

- They are not spectators; they are the witnesses the rite requires. The Aaronic over each FC1 belongs to the whole room, and the keepsake signing includes every hand present.

# **Closing Practice in Detail**

The three-layer closing pattern of the series runs one last time — and for the first time, all of it is in a senior's hands. The landing word, the one thing, the one practice, the blessing round, the sending: the closing senior holds the whole shape from memory. The team's discipline is to let them. The container was the first thing the seniors ever led, back in the fall; it is the right thing for them to lead last.

# **Between-Session Practice**

## For the new FC1s — the Leader Lab rhythm begins

- Come to Lab 1 of the serving cycle on the announced date with **one vital-signs observation from tonight's room**: a costly telling you noticed, what the room did in the first ten seconds when weight arrived, or someone going quiet and who moved toward them. One observation, seen with the lens from the charge. This is the first rep of the FC1's ongoing work: watching a room like a shepherd, never scoring it.
- Keep your own four-Connects rhythm going. The Lab's last word stands: you cannot lead from an empty well.
...
- For each new FC1: what did the rite confirm about their readiness, and what did it surface? Where is each one strong — container, process, blessing, the handing reflex — and what is the one growth edge the spring serving cycle should work first?
- Write a short coaching plan per FC1 for the serving cycle: which slots they lead next, what the Lab should give them, what their covering person should know to watch for. Three sentences each is enough; the point is that the team is still forming them, and commissioning was the start of that, not the end.
- If a senior's commissioning was deferred to the next cycle: how did tonight land for them and their family? What is the specific, dated path to their commissioning, and who owns walking it with them?

### **What the rite surfaced in the cohort**

- Which younger teens watched with hunger? Name them. They are the next cycle's Companions-in-Formation forming in front of us — the fourth generation in the verse. No approaches yet; just names, noted, prayed over, and revisited when the next cycle's discernment begins.
- What did the parents of non-senior teens say afterward? A commissioning like this recruits the imagination of a whole community, or fails to. Which was it?
...
- Was tonight a gate or a ceremony, honestly? The test is not how it felt at 5:30 PM; the test is who shows up to Lab 1. Put the Lab 1 attendance question on the next team agenda now.
...
**Commissioned:** \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ (date) — *in the presence of many witnesses (2 Tim. 2:2)*
...
*FC1 is a real and honorable place to stand. A teen who stays at FC1 for the rest of their life and leads a faithful group has arrived, not stalled.*

## The serving cycle begins
