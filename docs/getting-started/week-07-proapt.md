...
## WEEK 7 — HEARING GOD IN SCRIPTURE (75 minutes)
...
Week 7 is low-risk by design. After Week 6 the room needs a session where the work is steady and the Spirit is invited rather than confessed to. Standard Section 6 protocols apply but acute crisis disclosure is unlikely tonight.

**If a participant’s Apply or Tell surfaces something heavy.** Honor in the room briefly. Follow up offline within 48 hours.

**If anyone returns from Week 6 still carrying weight.** Cluster Companion checks in privately before or after the session. Pastoral 1:1 if needed.
...
- Week 1: Container holds. PROAPT will be practiced in family pairs in family clusters.
...
| T-30 min | All Companions gather (the room opens at 4:00). PRAY through the passage as a team — modeling Pray step. | All Companions |
| T-15 min | School day ends. Team + teen room-build crew build the room; families arrive while it builds. | Team + crew |
...
## **Block 2 — Re-entry, and the Room Reads Itself (4:21–4:31, 10 min)**
...
## **Block 4 — PROAPT Walked Together (4:37–4:47, 10 min)**
...
## **Block 5 — Bridge to the Clusters and Pair Structure (4:47–4:48, 1 min)**
...
## **Block 6 — PROAPT in Family Pairs (4:48–5:13, 25 min)**
...
**Pairing (1 min). Family pairs form (parent–teen from the same family by default; the Cluster Companion completes odd numbers within the cluster). Pairs find a quiet spot in or near the cluster space.**
...
**Cluster Companion opens (30 sec). “The Tell step. Each of us, one specific thing we heard tonight — from PROAPT or from the pair conversation. Specific. One sentence. We listen to receive, like Week 3. [Parent’s name], would you start us?”**
...
**Receiving (after each). The Cluster Companion (or anyone) responds: “We hear that” or “Thank you for naming that.” Brief. Receive without preaching.**
...
## **Block 8 — Merge and Between-Session (5:19–5:21, 2 min)**

## Script

*“Welcome back. One word each — not what you heard (that’s yours), but what tonight’s practice was like. [Parent’s name], start us off.”*

*(A parent begins — arranged beforehand. Receive each word. Anyone may pass.)*
...
*“For what to read — if you don’t already have a plan, the handout (hold up H7.3) has passage suggestions. Teens: pick a path — the Gospel of Mark list if you want short, concrete stories, or the Sermon on the Mount or Romans 8 worked through one passage at a time. Parents: same options, or pick from your current reading.”*
...
PROAPT scales fully for high-school teens. They can hold longer passages and deeper Apply work.

## Adjustments

- Passage suggestions can include Sermon on the Mount, Romans 8, John 13–17, the Gospel of Mark in chunks.
- Daily practice 10–15 minutes.
- Watch for the teen whose Observe is sophisticated but whose Apply is generic. Push for specificity.
- Watch for the teen who treats PROAPT as a Bible study technique they already know how to do. Frame it as a hearing practice that is different in kind from analysis.
- Tell step is often the hardest — teens hesitate to claim that God said something specific to them. Affirm gently. “What you heard counts even if you’re not 100% sure it was Him.”
...
- Tell step works powerfully for parents in the family pair itself — a parent telling their own teen what they heard is the design working. It also works in marriage, in the cluster, or with a friend from the series.
...
- Family pairs went into PROAPT without resistance. Most participants worked the full structure. At least one parent-teen pair's Tell landed — a parent and a teen telling each other what they heard.
...
- The room came back from Week 6 unable to engage. May indicate Week 6 was too heavy or follow-up was missed.
...
*One passage per day for the next seven days. Teens and parents pick from the same paths. Pick one and stay in it.*

## **The Gospel of Mark path — Mark 1–2**
...
## **The Sermon on the Mount or Romans 8 paths**
...
## **Parents — your choice or a Psalm-and-Gospel pairing**
