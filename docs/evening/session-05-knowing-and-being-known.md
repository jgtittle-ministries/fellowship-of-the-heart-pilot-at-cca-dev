# Session 5 — Knowing and Being Known

*FotH Evening · Anchor: Ecclesiastes 4:9–12*

**This evening.** The journey moves from Self into Others as the dominant
Connect. The container we have been building is the teacher: what makes
this room different from the rest of life, and where do those conditions —
...
**The standing practice — every day, both weeks.** Morning, five minutes:
"Lord, what are you up to today, and what do you want me to notice?"
Evening, one journal line: "What did I notice today?" These two questions
run in the background of every session's homework, from Session 1 to the
...
This session's full scripts and notes are in the school form's
[Week 5 Companion lesson plan](../getting-started/week-05-known.md); what
follows is what the evening form changes.

- **The check-in carries more.** If this is the group's first evening
  back, the check-in acknowledges the gap honestly — what survived the
  pause is data, not failure. On an ordinary cycle it carries two weeks of
  practice and the end-of-week-one check-in reports.
- **The teaching is the container holder's own charge.** The four
  conditions are the very things the container holder carries. The content
  presenter teaches them; the container holder embodies them in real time.
  The room gets the lesson twice.
...
- **Friendship material can carry weight** — the friend who left, the
  ...
  mapping block; anything heavy hands off per the leader's guidelines.
- **The pause-gap comparison.** If this follows a long break, resist
  letting the check-in become a referendum on faithfulness. What survived
  the break is the finding; shame is not on the agenda.
